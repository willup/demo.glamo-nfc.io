...
class GenericUSB extends class CommunicationBase {
  ...
  async transferin() {
    ...
    if ((e("transferin begin"), null == this.receiver)) {
      ...
      console.log("nhan20==== transferIn input: ", this.endno_in, this.receive_buffer_size, e, this.device);
...
class Pcsc {
  ...
  async transparentExchange(r, t, i, a, o, s, n, _, c) {
    ...
    if (
      ...
      console.log("=====nhan==== transparentExchange 3", r,t);
      const e = 130;
      console.log("=====nhan==== transparentExchange 3", (t.length >> 8),((t.length >> 8) & 255), (255 & t.length));
